        ...
        <div class="row">
            ...
            <div class="col-10">
                <div class="card p-4">
                    ...
                    <form method="POST" action="update_staff_admin.php">
                        ...
                        <div class="mb-3">
                            <label for="password" class="form-label">รหัสผ่านใหม่ (ถ้าไม่เปลี่ยนให้เว้นว่าง)</label>
                        ...
                        <div class="d-flex justify-content-start gap-2">
                            ...
                            <a href="staff_admin.php" class="btn btn-danger">ยกเลิก</a>
                        </div>
                    </form>
                </div>
            </div>
