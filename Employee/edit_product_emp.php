...
if (isset($_GET['product_id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<script>alert('ไม่พบข้อมูลสินค้า'); window.location.href='product_emp.php';</script>";
        exit();
    }
    ...
    echo "<script>alert('ไม่มีการระบุ ID สินค้า'); window.location.href='product_emp.php';</script>";
    exit();
}
?>
        ...
        <div class="row">
            ...
            <div class="card mt-3 pb-5 px-2 col-10">
                ...
                <form action="update_product.php" method="POST" enctype="multipart/form-data">
                    ...
                    <a href="product_emp.php" class="btn btn-danger">ยกเลิก</a>
                </form>
            </div>
</body>
